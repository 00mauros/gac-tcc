                ...
                <>
                    <S.TableWrapper>
                        <S.Table maxHeight={false}>
                            ...
                            {activities && activities.map((activity: any, index) =>
                                <tbody>
                                    <S.TableRow key={index}>
                                        <>
                                            {openModal && <Modal type="comments" initialActivityValues={activity} />}
                                            <td>{activity.category || "Não informada"}</td>
                                            <td>{activity.workload} horas</td>
                                            <td><img onClick={() => setOpenModal(true)} src={openIcon} alt="openIcon" /></td>
                                            <S.Status
